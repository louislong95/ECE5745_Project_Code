...
# flow.py
#=========================================================================
# Flow setup for single-cycle integer multiplier
#
...
def construct():
  ...
  parameters = {
    ...
    'design_name'    : 'lab1_imul_IntMulScycleRTL',
    'clock_period'   : 6.0,
    'flatten_effort' : 0,
    'adk'            : adk_name,
    'adk_view'       : adk_view,
    ...
    'rtl'            : 'lab1_imul_IntMulScycleRTL.v',
    'vcd'            : '''
                          "imul-rtl-scycle-small.vcd"
                          "imul-rtl-scycle-large.vcd"
                          "imul-rtl-scycle-lomask.vcd"
                          "imul-rtl-scycle-himask.vcd"
                          "imul-rtl-scycle-lohimask.vcd"
                          "imul-rtl-scycle-sparse.vcd"
                       ''',
  }
