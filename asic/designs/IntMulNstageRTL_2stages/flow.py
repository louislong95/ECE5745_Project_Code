...
# flow.py
#=========================================================================
# Flow setup for pipelined integer multiplier with 2 stages
#
...
def construct():
  ...
  parameters = {
    ...
    'design_name'    : 'lab1_imul_IntMulNstageRTL_2stages',
    'clock_period'   : 6.0,
    'flatten_effort' : 0,
    'adk'            : adk_name,
    'adk_view'       : adk_view,
    ...
    'rtl'            : 'lab1_imul_IntMulNstageRTL_2stages.v',
    'vcd'            : '''
                          "imul-rtl-2stage-small.vcd"
                          "imul-rtl-2stage-large.vcd"
                          "imul-rtl-2stage-lomask.vcd"
                          "imul-rtl-2stage-himask.vcd"
                          "imul-rtl-2stage-lohimask.vcd"
                          "imul-rtl-2stage-sparse.vcd"
                       ''',
  }
