...
def construct():
  ...
  parameters = {
    ...
    'rtl'            : 'lab1_imul_IntMulVarLatRTL.v',
    'vcd'            : '''
                          "imul-rtl-var-small.vcd"
                          "imul-rtl-var-large.vcd"
                          "imul-rtl-var-lomask.vcd"
                          "imul-rtl-var-himask.vcd"
                          "imul-rtl-var-lohimask.vcd"
                          "imul-rtl-var-sparse.vcd"
                       ''',
  }
