...
# flow.py
#=========================================================================
# Flow setup for pipelined integer multiplier with 4 stage
#
...
def construct():
  ...
  parameters = {
    ...
    'design_name'    : 'lab1_imul_IntMulNstageRTL_4stages',
    'clock_period'   : 6.0,
    'flatten_effort' : 0,
    'adk'            : adk_name,
    'adk_view'       : adk_view,
    ...
    'rtl'            : 'lab1_imul_IntMulNstageRTL_4stages.v',
    'vcd'            : '''
                          "imul-rtl-4stage-small.vcd"
                          "imul-rtl-4stage-large.vcd"
                          "imul-rtl-4stage-lomask.vcd"
                          "imul-rtl-4stage-himask.vcd"
                          "imul-rtl-4stage-lohimask.vcd"
                          "imul-rtl-4stage-sparse.vcd"
                       ''',
  }
