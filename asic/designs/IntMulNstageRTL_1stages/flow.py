...
# flow.py
#=========================================================================
# Flow setup for pipelined integer multiplier with 1 stage
#
...
def construct():
  ...
  parameters = {
    ...
    'design_name'    : 'lab1_imul_IntMulNstageRTL_1stages',
    'clock_period'   : 6.0,
    'flatten_effort' : 0,
    'adk'            : adk_name,
    'adk_view'       : adk_view,
    ...
    'rtl'            : 'lab1_imul_IntMulNstageRTL_1stages.v',
    'vcd'            : '''
                          "imul-rtl-1stage-small.vcd"
                          "imul-rtl-1stage-large.vcd"
                          "imul-rtl-1stage-lomask.vcd"
                          "imul-rtl-1stage-himask.vcd"
                          "imul-rtl-1stage-lohimask.vcd"
                          "imul-rtl-1stage-sparse.vcd"
                       ''',
  }
