...
def construct():
  ...
  parameters = {
    ...
    'rtl'            : 'lab1_imul_IntMulFixedLatRTL.v',
    'vcd'            : '''
                          "imul-rtl-fixed-small.vcd"
                          "imul-rtl-fixed-large.vcd"
                          "imul-rtl-fixed-lomask.vcd"
                          "imul-rtl-fixed-himask.vcd"
                          "imul-rtl-fixed-lohimask.vcd"
                          "imul-rtl-fixed-sparse.vcd"
                       ''',
  }
