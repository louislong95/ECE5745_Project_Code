...
#-------------------------------------------------------------------------
# Variable values passed through
#-------------------------------------------------------------------------

set user_aspect_ratio $::env(floorplan_ratio)
set user_core_density $::env(floorplan_util)
...
set core_aspect_ratio   $user_aspect_ratio;
set core_density_target $user_core_density;
...
floorPlan -r  $core_aspect_ratio $core_density_target \
              $core_margin_l $core_margin_b           \
              $core_margin_r $core_margin_t
