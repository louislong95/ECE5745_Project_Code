...
set lst_extra_link_libraries [glob -nocomplain inputs/dbs/*.db]
...
set_app_var link_library   "* inputs/adk/stdcells.db $pt_extra_link_libraries $lst_extra_link_libraries"
...
read_sdc "inputs/design.pt.sdc"
source inputs/clk-def.tcl
