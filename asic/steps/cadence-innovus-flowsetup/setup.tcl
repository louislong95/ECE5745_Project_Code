...
set vars(libs_typical,timing) [join "
                                ...
                                [glob -nocomplain inputs/libs/*.lib]
                              "]
...
set vars(lef_files) [join "
                      ...
                      [glob -nocomplain inputs/lefs/*.lef]
                    "]
...
# - VSSE        : from srams
# - vdd         : from OpenRAM SRAMs
# - vss gnd     : from OpenRAM SRAMs

set vars(power_nets)  "VDD VNW VDDPST POC VDDCE VDDPE vdd"
set vars(ground_nets) "VSS VPW VSSPST VSSE vss gnd"
