...
def test_beq( pytestconfig, name, test ):
...
def test_beq_rand_delays( pytestconfig ):
  run_test( pytestconfig,
            ProcFL, inst_beq.gen_random_test,
...
def test_bne( pytestconfig, name, test ):
  run_test( pytestconfig, ProcFL, test )
...
def test_bne_rand_delays( pytestconfig ):
  run_test( pytestconfig,
            ProcFL, inst_bne.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_bge( pytestconfig, name, test ):
  run_test( pytestconfig, ProcFL, test )
...
def test_bge_rand_delays( dump_vcd, pytestconfig ):
  run_test( pytestconfig,
            ProcFL, inst_bge.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_bgeu( pytestconfig, name, test ):
  run_test( pytestconfig, ProcFL, test )
...
def test_bgeu_rand_delays( pytestconfig ):
  run_test( pytestconfig,
            ProcFL, inst_bgeu.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_blt( pytestconfig, name, test ):
  run_test( pytestconfig, ProcFL, test )
...
def test_blt_rand_delays( pytestconfig ):
  run_test( pytestconfig,
            ProcFL, inst_blt.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_bltu( pytestconfig, name, test ):
  run_test( pytestconfig, ProcFL, test )
...
def test_bltu_rand_delays( pytestconfig ):
  run_test( pytestconfig,
            ProcFL, inst_bltu.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
