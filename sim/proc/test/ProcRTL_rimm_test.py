...
def test_addi( pytestconfig, name, test, dump_vcd, test_verilog ):
...
def test_addi_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_addi.gen_random_test, dump_vcd, test_verilog,
...
def test_andi( pytestconfig, name, test, dump_vcd, test_verilog ):
  run_test( pytestconfig, ProcRTL, test, dump_vcd, test_verilog )

def test_andi_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_andi.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_ori( pytestconfig, name, test, dump_vcd, test_verilog ):
  run_test( pytestconfig, ProcRTL, test, dump_vcd, test_verilog )

def test_ori_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_ori.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_xori( pytestconfig, name, test, dump_vcd, test_verilog ):
  run_test( pytestconfig, ProcRTL, test, dump_vcd, test_verilog )

def test_xori_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_xori.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_slti( pytestconfig, name, test, dump_vcd, test_verilog ):
  run_test( pytestconfig, ProcRTL, test, dump_vcd, test_verilog )
...
def test_slti_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_slti.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sltiu( pytestconfig, name, test, dump_vcd, test_verilog ):
  run_test( pytestconfig, ProcRTL, test, dump_vcd, test_verilog )
...
def test_sltiu_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_sltiu.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srai( pytestconfig, name, test, dump_vcd, test_verilog ):
  run_test( pytestconfig, ProcRTL, test, dump_vcd, test_verilog )
...
def test_srai_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_srai.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srli( pytestconfig, name, test, dump_vcd, test_verilog ):
  run_test( pytestconfig, ProcRTL, test, dump_vcd, test_verilog )
...
def test_srli_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_srli.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_slli( pytestconfig, name, test, dump_vcd, test_verilog ):
  run_test( pytestconfig, ProcRTL, test, dump_vcd, test_verilog )
...
def test_slli_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_slli.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_lui( pytestconfig, name, test, dump_vcd, test_verilog ):
  run_test( pytestconfig, ProcRTL, test, dump_vcd, test_verilog )
...
def test_lui_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_lui.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_auipc( pytestconfig, name, test, dump_vcd, test_verilog ):
  run_test( pytestconfig, ProcRTL, test, dump_vcd, test_verilog )
...
def test_auipc_rand_delays( pytestconfig, dump_vcd, test_verilog ):
  run_test( pytestconfig,
            ProcRTL, inst_auipc.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
